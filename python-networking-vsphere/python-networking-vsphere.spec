...
Name:       python-networking-vsphere
Version:    3.0.1
Release:    2 
...
%description
CTyun cloud  set of Neutron drivers and agents to manage VCenter clusters.
...
%changelog
* Thu Mar 8 2018 Tangwei Li <litangw@chinatelecom.cn> - 3.0.1-2
- Release to 3.0.1-2.
* Tue Jan 23 2018 Tangwei Li <litangw@chinatelecom.cn> - 3.0.1-1
- Initial And Update Version to 3.0.1 and Build package.
